...
public:
	...
	void execute(std::function<void()> callable);		//executes a callable at the set log level
	void execute(std::list<function<void()>> callables);//Executes a sequenece of callables at the set log level
